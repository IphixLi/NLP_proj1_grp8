...
track={}
hint_words=["drama","television","movie","film","award","comedy","musical","picture","song","video"]
...
for entry in json_text:
    ...
    if "nominated for" in normalized_text:
        nominated_text=normalized_text.split("nominated for")
        pattern = r'[?!.,|]'
...
with open('stage/nominated_keyword.json', 'w', encoding='utf-8') as f:
